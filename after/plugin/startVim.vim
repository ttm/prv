...
fu! StartChatter() " {{{
  " This curdir dont not function as expected, it makes Vim download
  " VimChatBot in the file where StartChatter() is called
...
"
" :Todo categorizacao das sessoes, anotacoes, etc. Tvz tags mm.
" Comecando arbitrario: sem nada, com +, com # etc, no comeco e/ou
" fim, ou padroes mais complexos: $%[[[[
"
" :Todo fazer codigos para os capitulos dos livros p ufabc e
" screencast p cada capitulo usando o código anotado p os slides.

" :Todo adapt Goethe's book on colors to be observed in modern
" computer screens
"
" :Todo https://en.wikipedia.org/wiki/Siteswap for LR music
"
" :Todo make PV_ use transitions between vibrato frequencies too (not
" only for the main frequency)
"
" :Todo make declamation of vaca borolenta entreolado rabo with espeak.
"
" :Todo 
" }}}
