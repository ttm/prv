...
setup(
    ...
    description='b0t is for cognitive computing with swarms of bots/souls/poets',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/ttm/prv',
    ...
    keywords=['bot', 'chat', 'computational intelligence', 'swarm intelligence',
            'bot swarm', 'soul swarm', 'poet swarm',
            'mythology', 'scientific writting', 'poetry', 'cosmology', 'Vim',
            'physics', 'music', 'synthesis', 'psychophysics',
            'symmetry', 'change ringing', 'campanology', 'group theory',
